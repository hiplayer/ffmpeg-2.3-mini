                                ...
                                int bit_size)
{
    ...
    //av_log(NULL, AV_LOG_FATAL, "%s,%d bit_size:%d\n",__FUNCTION__, __LINE__,bit_size);
    //print_trace();
                                 ...
                                 int byte_size)
{
    if (byte_size > INT_MAX / 8 || byte_size < 0)
        byte_size = -1;
    av_log(NULL, AV_LOG_FATAL, "%s,%d bit_size:%d\n",__FUNCTION__, __LINE__,byte_size * 8);
...
{
	//av_log(NULL, AV_LOG_FATAL, "%s,%d gb->size_in_bits:%d,get_bits_count(gb):%d\n",__FUNCTION__, __LINE__, gb->size_in_bits ,get_bits_count(gb));
